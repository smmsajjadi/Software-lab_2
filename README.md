...
<td width="284">
 ...
 گام ۵: جمع بندی
در پوشه جدید تغییرات اعمال شد.


 پاسخ پرسش ها
1. در پوشه دوم تمامی message service ها تغییر کرد. Validation logic کپسوله شد. MessageService قاعده open-close را الان رعایت میکند و برای هر پیام خاص تر و دقیق تر طراحی شده است. همچنین کلاس Main مستقیما دیگر خدمات پیام نمیدهد.
با در نظر گرفتن تغییرات گفته شده در بالا 6 کلاس به صورت کلی متافوت طراحی میشدند. و حداقل 8 تغییر در جدول 2 اتفاق می افتاد
